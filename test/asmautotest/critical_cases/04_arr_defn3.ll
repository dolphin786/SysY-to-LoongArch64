...
label_entry:
  ...
  store i32 7, i32* %v11
  %v12 = getelementptr i32, i32* %v11, i32 1
  store i32 8, i32* %v12
  ...
  %v17 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %v3, i32 0, i32 2, i32 1
  %v18 = load i32, i32* %v17
  store i32 %v18, i32* %v16
  %v19 = getelementptr i32, i32* %v15, i32 2
  store i32 3, i32* %v19
  %v20 = getelementptr i32, i32* %v19, i32 1
  store i32 4, i32* %v20
  %v21 = getelementptr i32, i32* %v15, i32 4
  store i32 5, i32* %v21
  %v22 = getelementptr i32, i32* %v21, i32 1
  store i32 6, i32* %v22
  %v23 = getelementptr i32, i32* %v15, i32 6
  store i32 7, i32* %v23
  %v24 = getelementptr i32, i32* %v23, i32 1
  store i32 8, i32* %v24
  %v25 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %v13, i32 0, i32 3, i32 1
  %v26 = load i32, i32* %v25
  %v27 = add i32 %v26, 0
  %v28 = add i32 %v27, 6
  %v29 = add i32 %v28, 0
  store i32 %v29, i32* %v0
  br label %label_ret
